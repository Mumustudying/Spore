...
'''
输入需要检测目标种类: spore/rice/vegetables
'''
...
class YOLO(object):
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        #   设置字体与边框厚度
        #---------------------------------------------------------#
        font        = ImageFont.truetype(font='/mnt/ssd/lzx/python/Yolo/yolov8_spore/model_data/simhei.ttf', size=np.floor(3e-2 * image.size[1] + 0.5).astype('int32'))
