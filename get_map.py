...
if __name__ == "__main__":
    ...
    #--------------------------------------------------------------------------------------#
    classes_path    = '/mnt/ssd/lzx/python/Yolo/yolov8_spore/model_data/voc_classes.txt'
    #--------------------------------------------------------------------------------------#
    ...
    #   默认指向根目录下的VOC数据集
    #-------------------------------------------------------#
    VOCdevkit_path  = '/mnt/ssd/lzx/data/VOCdevkit_Spore'
    #-------------------------------------------------------#
    #   结果输出的文件夹，默认为map_out
    #-------------------------------------------------------#
    map_out_path    = '/mnt/ssd/lzx/python/Yolo/yolov8_spore/map_out'

    image_ids = open(os.path.join(VOCdevkit_path, "/mnt/ssd/lzx/data/VOCdevkit_Spore/VOC2007/ImageSets/Main/test.txt")).read().strip().split()
